...
readata<- alldata %>%
  ...
  select(state:system, Lat:allo_all, op_kwh_p, op_kwh_b, op_ccn,    re_opm, re_cpp)
...
## Data Explorer ###########################################
  ...
  output$systable <- DT::renderDataTable({
    df <- readata %>%
      ...
      mutate(Action = paste('<a class="go-map" href="" data-lat="', Lat, '" data-long="', Long, '" data-sys="', system, '"><i class="fa fa-crosshairs"></i></a>', sep=""))
